...
public class RNDocumentPickerModuleZowie extends ReactContextBaseJavaModule {
  public static final String NAME = "RNDocumentPickerZowie";
  ...
  public RNDocumentPickerModuleZowie(ReactApplicationContext reactContext) {
    super(reactContext);
