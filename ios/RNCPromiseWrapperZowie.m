...
@interface RNCPromiseWrapperZowie ()
...
@implementation RNCPromiseWrapperZowie
...
-(void)reject:(NSString *)message withCode:(NSString*) errorCode withError:(NSError *)error {
    ...
    NSString* errorMessage = [NSString stringWithFormat:@"RNCPromiseWrapperZowie: %@, %@", message, error.description];
